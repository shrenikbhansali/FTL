...
usage() {
  cat <<'USAGE'
Usage: run_local_individual_3run_eval_a40.sh [options]
...
Options:
  ...
  --run-id           3run pipeline id (default: latest in 3multiconfig/results).
...
RESULTS_ROOT="$ROOT_DIR/3multiconfig/results"
LOGS_ROOT="$ROOT_DIR/3multiconfig/logs"
